...
def protocol_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "jobs": {
            ...
            "scope": "Existing Jobs search results only. Discovers the Obsidian Scheduled Job List block and requires page access plus block EDIT permission. Prefers the standard Jobs page; ambiguous placements disable triggering.",
