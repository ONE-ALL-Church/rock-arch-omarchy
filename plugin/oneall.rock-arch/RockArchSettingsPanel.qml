...
Column {
  ...
  readonly property bool inputActive: profileNameField.activeFocus ||
    ...
    settingsPanel.controller.profileRenameInputActive || shortcuts.inputActive
  ...
  function toggleMenuBarPreference() {
    if (controller.preferenceShowMenuBar && !controller.shortcut.configured) {
      controller.feedbackText = "Add a working keyboard shortcut before hiding the icon."
      controller.shortcut.refresh()
      shortcuts.primaryButton.forceActiveFocus(Qt.TabFocusReason)
      return
    }
  ...
  Column {
    ...
    Repeater {
      ...
      delegate: CursorSurface {
        ...
        readonly property bool managing: settingsPanel.expandedProfileId ===
          profileRow.modelData.id
        ...
        ColumnLayout {
          ...
          RowLayout {
            ...
            Button {
              ...
              text: profileRow.managing ? "Done" : "Edit"
              tooltipText: "Manage " + profileRow.modelData.name
              focusable: true
              fontSize: Style.font.caption
              horizontalPadding: Style.spacing.md
              verticalPadding: Style.spacing.xs
              enabled: !settingsPanel.controller.setupBusy
              onActiveFocusChanged: settingsPanel.controller.revealFocusedControl(manageProfileButton)
              onClicked: {
                settingsPanel.expandedProfileId = profileRow.managing ? "" : profileRow.modelData.id
                settingsPanel.controller.pendingRemoveProfileId = ""
                settingsPanel.controller.pendingSignOut = false
                settingsPanel.controller.editLoginMode = false
                settingsPanel.controller.setupUsername = ""
                settingsPanel.controller.setupPassword = ""
                settingsPanel.controller.editingProfileId = ""
                settingsPanel.controller.editingProfileName = ""
                settingsPanel.controller.profileRenameInputActive = false
                settingsPanel.controller.feedbackText = ""
              }
            }
          }
          ...
          Text {
            visible: profileRow.modelData.isActive && (profileRow.managing ||
              !settingsPanel.controller.rockConfigured || settingsPanel.controller.magnusState === "error")
            Layout.fillWidth: true
            ...
            textFormat: Text.PlainText
            color: settingsPanel.controller.rockConfigured ? settingsPanel.dim : Color.urgent
            font.family: Style.font.family
            font.pixelSize: Style.font.caption
            elide: Text.ElideRight
          }
          ...
          Flow {
            visible: profileRow.managing && !profileRow.editing
            Layout.fillWidth: true
  ...
  Column {
    ...
    Toggle {
      ...
      description: settingsPanel.controller.shortcut.configured
        ? ""
        : "Set up a shortcut before hiding the icon."
    ...
    Toggle {
      ...
      description: "Include family, campus, and connection details."
